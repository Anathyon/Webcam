...
const staggerDelay = (elements: NodeListOf<Element>, baseDelay = 0, increment = 100) => {
...
export const animateGalleryClose = (): Promise<void> => {
...
export const setupModal = (): void => {
    const modal = document.querySelector('#gallery-modal') as HTMLDialogElement;
