...
const filtroStatusOverlay = document.querySelector('#filtro-status-overlay') as HTMLSpanElement;
const filterListUl = document.querySelector('#filter-list') as HTMLUListElement;
const filterCountSpan = document.querySelector('#filter-count') as HTMLSpanElement;
...
const btnAbrirGaleriaDesktop = document.querySelector('#btn-abrir-galeria-desktop') as HTMLButtonElement;
const btnAbrirGaleriaPreview = document.querySelector('#btn-abrir-galeria-preview') as HTMLButtonElement;
const btnFecharModal = document.querySelector('#btn-fechar-modal') as HTMLButtonElement;
const galeriaGrid = document.querySelector('#galeria-grid') as HTMLDivElement;
const galleryPreview = document.querySelector('#gallery-preview') as HTMLDivElement;

// Painel Rápido
const capturasCount = document.querySelector('#capturas-count') as HTMLParagraphElement;
const lastPhotoTime = document.querySelector('#last-photo-time') as HTMLParagraphElement;
...
const aplicarFiltro = (index: number, updateGlobalIndex: boolean = true): void => {
...
const salvarFoto = (dataUrl: string): void => {
    const fotos = getFotos();
    const novaFoto: Foto = { id: Date.now().toString(), dataUrl, timestamp: Date.now() };
    fotos.push(novaFoto);
